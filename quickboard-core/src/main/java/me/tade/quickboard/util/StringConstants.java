...
public class StringConstants
{
	...
	public static final String ERROR_CANNOT_CHANGE = HEADER + "§cCould not change scoreboard!";
	public static final String ERROR_DOES_NOT_EXIST = HEADER + "§cScoreboard doesn't exists!";
	...
	public static final String INSERTED_EMPTY_LINE = HEADER + "§aInserted empty line!";
