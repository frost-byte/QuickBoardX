...
import static me.tade.quickboard.util.StringConstants.ADDED_EMPTY_LINE;
import static me.tade.quickboard.util.StringConstants.ADDED_LINE;
import static me.tade.quickboard.util.StringConstants.ERROR_ALREADY_USED;
import static me.tade.quickboard.util.StringConstants.ERROR_CANNOT_CHANGE;
import static me.tade.quickboard.util.StringConstants.ERROR_DOES_NOT_EXIST;
import static me.tade.quickboard.util.StringConstants.ERROR_FAILED;
import static me.tade.quickboard.util.StringConstants.ERROR_FILE_CREATION;
import static me.tade.quickboard.util.StringConstants.ERROR_INVALID_NUMBER;
import static me.tade.quickboard.util.StringConstants.HEADER;
import static me.tade.quickboard.util.StringConstants.INSERTED_EMPTY_LINE;
import static me.tade.quickboard.util.StringConstants.INSERTED_LINE;
import static me.tade.quickboard.util.StringConstants.LINE_REMOVED;
import static me.tade.quickboard.util.StringConstants.OUT_OF_BOUNDS;
import static me.tade.quickboard.util.StringConstants.SCOREBOARD_CHANGED;
...
public abstract class BaseBoardManager
{
	 ...
	 */
	public BaseBoardManager(QuickBoard plugin) {
		this.plugin = plugin;
